...
export const DEFAULT_WIDGET_LAYOUT: DashboardWidgetLayoutItem[] = [
  ...
  { id: 'widget-14', width: 4, height: 450, order: 11.1 },
  { id: 'widget-11', width: 12, height: 500, order: 12 },
  { id: 'widget-12', width: 12, height: 450, order: 13 },
  { id: 'widget-13', width: 12, height: 450, order: 14 },
];
...
export const ADMIN_DEFAULT_WIDGET_LAYOUT: DashboardWidgetLayoutItem[] = [
  ...
  { id: 'widget-14', width: 8, height: 430, order: 11.1 },
  { id: 'widget-9', width: 4, height: 430, order: 11.2 },
  { id: 'widget-11', width: 12, height: 500, order: 12 },
  { id: 'widget-12', width: 12, height: 450, order: 13 },
  { id: 'widget-13', width: 12, height: 450, order: 14 },
];
