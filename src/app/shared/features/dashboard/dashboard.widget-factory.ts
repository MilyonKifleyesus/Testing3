...
export function createDefaultDashboardWidgets(): DashboardWidget[] {
  return [
    ...
    { id: 'widget-11', title: 'Projects Comparison by Station', subtitle: 'Heatmap of average defects by station', type: 'heatmap', chartOptions: busPulseData.projectsByStationHeatmap, width: 12, height: 500, order: 11, loading: true },
