...
export function createDefaultDashboardWidgets(): DashboardWidget[] {
  return [
    ...
    { id: 'widget-13', title: 'Project Timeline', subtitle: 'Project schedules and milestones', type: 'timeline', chartOptions: busPulseData.projectTimelineChart, width: 12, height: 450, order: 13, loading: true },
  ];
}
