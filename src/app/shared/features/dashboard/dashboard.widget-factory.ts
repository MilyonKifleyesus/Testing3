...
export function createDefaultDashboardWidgets(): DashboardWidget[] {
  return [
    ...
    { id: 'widget-11', title: 'Projects Comparison by Area (Total Defects)', subtitle: 'Heatmap of defect count by area and project', type: 'heatmap', chartOptions: busPulseData.projectsByStationHeatmap, width: 12, height: 500, order: 12, loading: true },
