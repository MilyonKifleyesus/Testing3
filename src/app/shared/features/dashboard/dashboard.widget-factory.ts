...
export function createDefaultDashboardWidgets(): DashboardWidget[] {
  return [
    ...
    { id: 'widget-14', title: 'Recent Activities', subtitle: 'Latest inspector sync activity', type: 'stat', width: 4, height: 450, order: 10.1, loading: false },
  { id: 'widget-11', title: 'Projects Comparison by Station Type', subtitle: 'Heatmap of StationTrackers count by station type and project', type: 'heatmap', chartOptions: busPulseData.projectsByStationHeatmap, width: 12, height: 500, order: 11, loading: true },
  { id: 'widget-12', title: 'Average Type of Time Comparison by Project', subtitle: 'Setup, inspection and reporting time', type: 'chart', chartOptions: busPulseData.stationTimeComparisonChart, width: 12, height: 450, order: 12, loading: true },
    { id: 'widget-15', title: 'Vehicle Station Tracking', subtitle: 'Vehicle station timeline', type: 'timeline', chartOptions: busPulseData.vehicleStationTrackingChart, width: 12, height: 450, order: 13, loading: true },
    ...
    { id: 'widget-map', title: 'Fleet Map', subtitle: 'All mapped projects', type: 'map', width: 12, height: 500, order: 15, loading: true },
  ];
}