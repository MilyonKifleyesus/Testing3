...
@Component({
  selector: 'app-fluorescence-map-command-menu',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './fluorescence-map-command-menu.component.html',
  styleUrls: ['./fluorescence-map-command-menu.component.scss'],
})
export class FluorescenceMapCommandMenuComponent implements OnInit, OnDestroy {
